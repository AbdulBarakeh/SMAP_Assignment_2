...
public ExecutorService executor = Executors.newSingleThreadExecutor();
    ...
    public WordRepository(Context context) {
        wordDatabase = Room.databaseBuilder(context,WordDatabase.class,"WordDatabase5")
//                .fallbackToDestructiveMigration()
                .addCallback(new RoomDatabase.Callback() {
                    @Override
                    public void onCreate(@NonNull SupportSQLiteDatabase db) {
                        super.onCreate(db);
                        db.execSQL("INSERT INTO WordEntity(image,name,pronunciation,description,rating,notes)" +
                                " VALUES (\"https://media.owlbot.info/dictionary/images/kkkkkkw.jpg.400x400_q85_box-0,0,600,600_crop_detail.jpg\",\"Buffalo\",\"ˈbəf(ə)ˌlō\",\"a heavily built wild ox with backward-curving horns, found mainly in the Old World tropics.\",\"\",0)");
                        db.execSQL("INSERT INTO WordEntity(image,name,pronunciation,description,rating,notes)" +
                                " VALUES (\"https://media.owlbot.info/dictionary/images/nnnt.png.400x400_q85_box-0,0,500,500_crop_detail.png\",\"Camel\",\"ˈkaməl\",\"a large, long-necked ungulate mammal of arid country, with long slender legs, broad cushioned feet, and either one or two humps on the back. Camels can survive for long periods without food or drink, chiefly by using up the fat reserves in their humps\",\"\",0)");
                        db.execSQL("INSERT INTO WordEntity(image,name,pronunciation,description,rating,notes)" +
                                " VALUES (\"https://media.owlbot.info/dictionary/images/sssssb.jpg.400x400_q85_box-0,0,500,500_crop_detail.jpg\",\"Cheetah\",\"ˈCHēdə\",\"a large slender spotted cat found in Africa and parts of Asia. It is the fastest animal on land.\",\"\",0)");
                        db.execSQL("INSERT INTO WordEntity(image,name,pronunciation,description,rating,notes)" +
                                " VALUES (\"https://media.owlbot.info/dictionary/images/rrrrrm.jpg.400x400_q85_box-0,0,500,500_crop_detail.jpg\",\"Crocodile\",\"ˈkräkəˌdīl\",\"a large predatory semiaquatic reptile with long jaws, long tail, short legs, and a horny textured skin.\",\"\",0)");
                        db.execSQL("INSERT INTO WordEntity(image,name,pronunciation,description,rating,notes)" +
                                " VALUES (\"https://media.owlbot.info/dictionary/images/27ti5gwrzr_Julie_Larsen_Maher_3242_African_Elephant_UGA_06_30_10_hr.jpg.400x400_q85_box-356,0,1156,798_crop_detail.jpg\",\"Elephant\",\"ˈeləfənt\",\"a very large plant-eating mammal with a prehensile trunk, long curved ivory tusks, and large ears, native to Africa and southern Asia. It is the largest living land animal.\",\"\",0)");
                    }
                })
                .build();
    }
